...
(function(/*! Stitch !*/) {
  ...
  "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\es5-shimify\\index": function(exports, require, module) {// vim:set ts=4 sts=4 sw=4 st:
...
});}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\json2ify\\index": function(exports, require, module) {/*
...
}());}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\jqueryify\\index": function(exports, require, module) {/*!
...
module.exports = jQuery;}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\index": function(exports, require, module) {module.exports = require('./lib/spine');}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\lib\\spine": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
...
}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\lib\\local": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
  var Spine;
...
}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\lib\\ajax": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
...
}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\lib\\route": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
...
}, "D:/Users\\amadou\\Documents\\Visual Studio 2010\\Projects\\cef3\\usbtoken\\res\\node_modules\\spine\\lib\\manager": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
  var $, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
}, "controllers/changePIN": function(exports, require, module) {(function() {
  var ChangePIN, Façade, Spine, Token,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  ChangePIN = (function(_super) {
    ...
    function ChangePIN(args) {
      var _this = this;
      ChangePIN.__super__.constructor.apply(this, arguments);
    ...
    ChangePIN.prototype.render = function() {
      return this.html(ChangePIN.templ());
    };
  ...
  GetPass = (function(_super) {

    __extends(GetPass, _super);
    ...
    GetPass.prototype.className = 'getpw';

    function GetPass() {
      var _this = this;
      GetPass.__super__.constructor.apply(this, arguments);
      this.bind('release', function() {
    ...
    GetPass.prototype.cancel = function(evt) {
      var _base;
      evt.preventDefault();
      evt.stopPropagation();
  ...
  Init = (function(_super) {
    ...
    Init.prototype.unRenderMsg = function(evt) {
      return 'Votre supporte ne sera pas re-initializer';
    };
  ...
  KeyMgr.KeyList = (function(_super) {
    ...
    function KeyList() {
      ...
      this.app.bind('selectionChanged', this.selectionChanged);
      this.bind('release', function() {
        this.app.unbind('selectionChanged', this.selectionChanged);
        this.toolsbar.release();
        this.keys.release();
        return delete this.app;
      });
    ...
    KeyList.Key = (function(_super1) {
      ...
      Key.prototype.toggle = function(evt) {
        evt.preventDefault();
        evt.stopPropagation();
      ...
      Key.prototype["export"] = function(evt) {
        evt.preventDefault();
        evt.stopPropagation();
        this.log("export:" + this.key.id);
        return false;
      };
      ...
      function Key(args) {
        ...
        this.bind('selectionChanged', function(key, checked) {
          _this.el.toggleClass('checked', checked);
          if (checked) {
            return _this.app.selectKey(key);
          } else {
            return _this.app.unSelectKey(key);
          }
        });
        this.bind('release', function() {
          return delete _this.app;
    ...
    KeyList.Toolsbar = (function(_super1) {
      ...
      Toolsbar.prototype.logPrefix = '(KeyList.Toolsbar)';
  ...
  KeyMgr.GenForm = (function(_super) {
...
}, "controllers/login": function(exports, require, module) {(function() {
  var App, Façade, Login, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Login = (function(_super) {
    ...
    Login.templ = require('views/login');

    Login.prototype.params = function() {
      var cleaned,
        _this = this;
      cleaned = function(key) {
        return (_this[key].val() || '').trim();
    ...
    Login.prototype.render = function() {
      return this.html(Login.templ(Login.viewopts(this.type)));
    };
  ...
  var Façade, GetPass, ResetPIN, Spine, Token, Unblock, Wizard,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  ResetPIN = (function(_super) {
    ...
    function ResetPIN() {
      ...
      ResetPIN.__super__.constructor.apply(this, arguments);
    }
  ...
  Start = (function(_super) {
    ...
    Start.tmpl = require('views/start');

    Start.prototype.render = function() {
      this.el.html(Start.tmpl());
      return this;
    };
  ...
  Unblock = (function(_super) {

    __extends(Unblock, _super);

    function Unblock() {
      var _this = this;
      Unblock.__super__.constructor.apply(this, arguments);
      this.bind('release', function() {
        return delete _this.controller;
      });
      this.delay(function() {
    ...
    Unblock.templ = require('views/unblock');
    ...
    Unblock.prototype.params = function() {
      var cleaned,
        _this = this;
      cleaned = function(key) {
        return (_this[key].val() || '').trim();
    ...
    Unblock.prototype.render = function() {
      return this.html(Unblock.templ(this.viewopts()));
    };

    Unblock.prototype.unblock = function(e) {
      var msg, params;
      this.log('@unblock');
      e.preventDefault();
      this.submitBtn.enable(false);
  ...
  App = (function(_super) {
    ...
    App.INITIAL_STATUS_CLASS = 'detecting';

    App.prototype.events = {
      'click .locale': 'changeLang'
    };

    App.prototype.changeLang = function(evt) {
      evt.prevenDefault();
      evt.stopPropagation();
      return false;
    };
    ...
    Msg = (function(_super1) {
      ...
      Msg.msgTempl = require('views/msg');

      Msg.prototype.show = function(p) {
        var id, msg,
          _this = this;
      ...
      Msg.prototype.clearAll = function() {
        return this.hide()();
      };
    ...
    App.prototype.info = function(opts) {
    ...
    App.prototype.alert = function(opts) {
      opts = typeof opts === 'string' ? {
        msg: opts
      } : opts;
      return this.msg.show({
    ...
    App.prototype.clearAllMsgs = function() {
      return this.msg.clearAll();
    };

    App.prototype.statusChanged = function(status) {
      this.log("App#statusChanged:" + status);
    ...
    App.prototype.become = function(s) {
      this.changeView(new s.Clss(s.args));
      if (s.info != null) {
        this.info(s.info);
      }
      if (s.alert != null) {
        return this.alert(s.alert);
      }
    };
    ...
    App.prototype.authrequired = function() {
      return {
        Clss: Login,
        args: {
          controller: this,
          doLogin: this.routeLogin,
    ...
    App.prototype.render = function() {
      ...
      if (this.currentView) {
        if (typeof this.currentView.render === 'function') {
          return this.body.html(this.currentView.render()).show('slide', {
            direction: 'right',
            easing: 'easeInOutElastic'
          }, 700, function() {
            var _base;
            return typeof (_base = _this.currentView).rendered === "function" ? _base.rendered() : void 0;
          });
        } else {
          return typeof (_base = this.currentView).rendered === "function" ? _base.rendered() : void 0;
        }
      }
    };
...
}, "lib/façade": function(exports, require, module) {(function() {
  var Façade, Key, Spine, Token,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Façade = (function(_super) {
    ...
    __extends(Façade, _super);

    function Façade() {
      return Façade.__super__.constructor.apply(this, arguments);
    }

    Façade.extend(Spine.Log);
  ...
  Wizard = (function(_super) {
    ...
    Wizard.include(Spine.Log);

    Wizard.include(Spine.Events);

    Wizard.prototype.logPrefix = '(Wizard)';
    ...
    Wizard.prototype.unRendered = function() {};
    ...
    function Wizard(options) {
      ...
      this.bind('stepChanged', function(step) {
        var _this = this;
    ...
    Wizard.prototype.info = function() {
      var _ref;
      return (_ref = this.app).info.apply(_ref, arguments);
    };

    Wizard.prototype.alert = function() {
      var _ref;
      return (_ref = this.app).alert.apply(_ref, arguments);
    };

    Wizard.prototype.rendered = function() {
    ...
    Wizard.prototype.next = function(step, params) {
      ...
      if (next = this.steps.shift()) {
        (_base = next.args)['vars'] || (_base['vars'] = {});
        for (key in params) {
          val = params[key];
          next.args['vars'][key] = val;
        }
        return this.app.delay((function() {
  ...
  Key = (function(_super) {
    ...
    Key.configure('Key', 'commonName', 'email', 'locality', 'state', 'organization', 'organizationalUnit', 'country', 'street', 'dn', 'serial', 'signatureAlgorithm', 'beginDate', 'endDate', 'keyUsage', 'friendlyName', 'basicContraints', 'engine', 'issuerCommonName', 'issuerEmail', 'issuerLocality', 'issuerState', 'issuerOrganization', 'issuerOrganizationalUnit', 'issuerCountry', 'issuerStreet');
  ...
  Key.KeyUsage.ALL = Key.KeyUsage.DigitalSignature | Key.KeyUsage.NonRepudiation | Key.KeyUsage.KeyEncipherment | Key.KeyUsage.DataEncipherment;
  ...
  Token = (function() {
    ...
    Token.AuthRequired = 'auth-required';
...
}, "views/changepin": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/getpass": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="form-title">');
      ...
      __out.push('</label>\n  <input name="pw_confirm" type="password" class="span3">\n\n  <cite class="help-block"><i class="icon-info-sign"></i> &nbsp;');
    
      __out.push(__sanitize(this.label));
    
      __out.push(' must be between ');
    
      __out.push(__sanitize(this.minLength));
    
      __out.push(' and ');
    
      __out.push(__sanitize(this.maxLength));
    
      __out.push(' caracters.</cite>\n  <button type="submit" class="btn default"><i class="icon-ok"></i> &nbsp;');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/key-mgr\\key": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('/purge" class="purge btn"><i class="icon-trash"></i></a>\n\t\t\t<a title="Telecharger" href="#/key/');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/key-mgr\\_key": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      if (this.type === Login.SO_LOGIN) {
        __out.push(__sanitize('as Admin'));
      }
    
      __out.push('</div>\n<form class="form login" method="post" action="#/login">\n  <label>Enter PIN</label>\n  <input name="pin" type="password" class="span3" autofocus>\n  <cite class="help-block"><i class="icon-info-sign"></i> &nbsp;PIN must be between ');
      ...
      __out.push(' caracters.</cite>\n  <button type="submit" class="btn default"><i class="icon-signin"></i> &nbsp;Sign in</button>\n</form>');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/msg": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<!-- args(type, closeable, msg) -->\n<div id="');
    
      __out.push(__sanitize(this.id));
    
      __out.push('" class="alert alert-');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/unblock": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<div class="form-header">Unblock your PIN</div>\n<form class="unblock form" method="post" action="#/unblock">\n  <label>Enter PUK</label>\n  <input name="puk" type="password" class="span3" autofocus>\n  <cite class="help-block"><i class="icon-info-sign"></i> &nbsp;PUK must be between ');
      ...
      __out.push(' caracters.</cite>\n  <button type="submit" class="btn default"><i class="icon-unlock"></i> &nbsp;Unblock</button>\n</form>');
